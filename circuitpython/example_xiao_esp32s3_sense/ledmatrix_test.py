...
Port of ../example/ledmatrix_test.py for the Seeed Studio XIAO ESP32S3 Sense.
Untested — see README "Board variants" section for details.
...
# GPIO1 (D0) is free: not used by the camera, SD card, I2C, or UART on this board.
DATA_PIN = microcontroller.pin.GPIO1
WIDTH      = 16           # columns
HEIGHT     = 32           # rows
